...
Plugin 'eleanor-clifford/vim-venus'
Plugin 'eleanor-clifford/vim-qalc'
Plugin 'eleanor-clifford/vim-dirdiff'
...
fun! BlogInit(title)
	...
	if ! filereadable(fname)
		...
		let header = [
					...
					\ 'author:',
					\ '  name: Ellie Clifford',
					\ '  avatar: "https://github.com/eleanor-clifford.png?size=48"',
					\ 'ogImage: ""',
					\ 'color: ""',
					\ '---',
					\ '',
...
let g:venus_ignorelist       = ['README.md', 'ellie.clifford.lol/blog']
" }}}
" Airline {{{
